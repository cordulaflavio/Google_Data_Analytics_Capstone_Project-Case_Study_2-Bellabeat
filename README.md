...
- Getting familiar with the tables and data (see [SQL file](https://github.com/cordulaflavio/Google_Data_Analytics_Capstone_Project-Case_Study_2-Bellabeat/blob/main/sql/process.sql))
